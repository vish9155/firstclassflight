...
import { FaCrown, FaPlaneDeparture, FaPassport, FaHeadset, FaTags, FaShieldAlt, FaPhone, FaEnvelope, FaWhatsapp } from 'react-icons/fa'
        ...
        <>
            <section>
                <div className='w-full'>
                    <div className='relative'>
                        <video src="/video/home.mp4" loop autoPlay muted></video>
                        <div className='absolute top-70 left-140'>
                            {/* <h1 className='text-lg sm:text-xl md:text-2xl '>Premium Business Class Flights at Exclusive Fares
                            </h1> */}
                        </div>
                    </div>
                </div>
                ...
                <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 p-5'>
                    ...
                    <div className='rounded-2xl shadow-lg text-blue-600 shadow-blue-600 z-50 transition-all duration-300 ease-in hover:-translate-y-4'>
                        ...
                        <div className='p-1 sm:p-2 md:p-3'>
                            ...
                            <div className='flex items-center justify-center'>
                                <NavLink to="tel:9155014125" className='text-center text-sm sm:text-base hover:text-red-600 transition-all duration-300 ease-in py-2'>9155014125</NavLink>
                            </div>
                        </div>
                    ...
                    <div className='rounded-2xl shadow-lg text-blue-600 shadow-blue-600 z-50 transition-all duration-300 ease-in hover:-translate-y-4'>
                        ...
                        <div className='p-1 sm:p-2 md:p-3'>
                            ...
                            <div className='flex items-center justify-center'>
                                <NavLink to="https://wa.me/9155014125" className='text-center text-sm sm:text-base hover:text-red-600 transition-all duration-300 ease-in py-2'>Chat With Us</NavLink>
                            </div>
                        </div>
            ...
            {/* <section>
                <div className="max-w-7xl mx-auto py-12 px-4">
                 <h2 className='text-xl sm:text-2xl md:text-3xl text-center'>Frequently Asked Questions</h2>
